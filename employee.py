...
class employeeClass:
    def __init__(self,root):
        ...
        #search
        SearchFrame=LabelFrame(self.root,text="Search Employee",font=("times new roman",16,"bold"),bd=2,relief=RIDGE,bg="white")
        ...
        txt_search=Entry(SearchFrame,textvariable=self.var_searchtxt,font=("times new roman",15),bg="#BCD2E8").place(x=200,y=10)
        btn_search=Button(SearchFrame,text="Search",command=self.search,font=("goudy old style",15),bg="#2E5984",fg="white",cursor="hand2").place(x=410,y=9,width=150,height=30)
        ...
        txt_empid=Entry(self.root,textvariable=self.var_emp_id,font=("times new roman",15),bg="#BCD2E8").place(x=150,y=150,width=180)
        txt_gender=Entry(self.root,textvariable=self.var_gender,font=("times new roman",15),bg="white").place(x=500,y=150,width=180)
        cmb_gender=ttk.Combobox(self.root,textvariable=self.var_gender,values=("Select","Male","Female"),state='readonly',justify=CENTER,font=("times new roman",14))
        cmb_gender.place(x=500,y=150,width=180)
        cmb_gender.current(0)
        txt_contact=Entry(self.root,textvariable=self.var_contact,font=("times new roman",15),bg="#BCD2E8").place(x=850,y=150,width=180)
        ...
        txt_Name=Entry(self.root,textvariable=self.var_name,font=("times new roman",15),bg="#BCD2E8").place(x=150,y=190,width=180)
        txt_DOB=Entry(self.root,textvariable=self.var_DOB,font=("times new roman",15),bg="#BCD2E8").place(x=500,y=190,width=180)
        txt_DOJ=Entry(self.root,textvariable=self.var_DOJ,font=("times new roman",15),bg="#BCD2E8").place(x=850,y=190,width=180)
        ...
        txt_email=Entry(self.root,textvariable=self.var_email,font=("times new roman",15),bg="#BCD2E8").place(x=150,y=230,width=180)
        txt_pass=Entry(self.root,textvariable=self.var_pass,font=("times new roman",15),bg="#BCD2E8").place(x=500,y=230,width=180)
        txt_utype=Entry(self.root,textvariable=self.var_utype,font=("times new roman",15),bg="white").place(x=850,y=230,width=180)
        cmb_utype=ttk.Combobox(self.root,textvariable=self.var_utype,values=("Select","Admin","Other"),state='readonly',justify=CENTER,font=("times new roman",14))
        ...
        self.txt_address=Text(self.root,font=("times new roman",15),bg="#BCD2E8")
        self.txt_address.place(x=150,y=270,width=300,height=60)
        txt_salary=Entry(self.root,textvariable=self.var_salary,font=("times new roman",15),bg="#BCD2E8").place(x=600,y=270,width=180)
        ...
        btn_clear=Button(self.root,text="Clear",command=self.clear,font=("goudy old style",15),bg="#607d8b",fg="white",cursor="hand2").place(x=740,y=305,width=110,height=28)
        btn_delete=Button(self.root,text="Delete",command=self.delete,font=("goudy old style",15),bg="#f44336",fg="white",cursor="hand2").place(x=860,y=305,width=110,height=28)
       ...
       #employee details
        ...
        self.EmployeeTable.column("salary",width=500)
    ...
    def add(self):
        ...
        try:
            if self.var_emp_id.get()=="" or self.var_name.get()=="":
                ...
                row = cur.fetchone()
                if row != None:
                    messagebox.showerror("Error","This Employee ID Already Exists, Try a Different ID",parent = self.root)
                else :
