...
class productClass:
    ...
    def __init__(self,root):
        ...
        #column1
        lbl_category=Label(product_frame,text="Category ",font=("times new roman",15),bg="white").place(x=30,y=60)
        lbl_supplier=Label(product_frame,text="Supplier ",font=("times new roman",15),bg="white").place(x=30,y=110)
        lbl_product=Label(product_frame,text="Name ",font=("times new roman",15),bg="white").place(x=30,y=160)
        lbl_price=Label(product_frame,text="Price ",font=("times new roman",15),bg="white").place(x=30,y=210)
        lbl_quantity=Label(product_frame,text="Quantity ",font=("times new roman",15),bg="white").place(x=30,y=260)
        lbl_status=Label(product_frame,text="Status ",font=("times new roman",15),bg="white").place(x=30,y=310)
        ...
        btn_clear=Button(product_frame,text="Clear",command=self.clear,font=("goudy old style",15),bg="#607d8b",fg="white",cursor="hand2").place(x=230,y=400,width=100,height=40)
        btn_delete=Button(product_frame,text="Delete",command=self.delete,font=("goudy old style",15),bg="#f44336",fg="white",cursor="hand2").place(x=340,y=400,width=100,height=40)

         #search
        SearchFrame=LabelFrame(self.root,text="Search Product",font=("times new roman",16,"bold"),bd=2,relief=RIDGE,bg="white")
