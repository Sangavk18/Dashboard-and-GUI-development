...
class categoryClass:
    ...
    def __init__(self,root):
        ...
        self.im1=self.im1.resize((500,255),Image.LANCZOS)
        ...
        self.im2=self.im2.resize((500,255),Image.LANCZOS)
    ...
    def delete(self):
        ...
        try:
            if self.var_cat_id.get()=="":
                ...
                row = cur.fetchone()
                if row == None:
                    messagebox.showerror("Error","Invalid Category cid",parent = self.root)
                else :
